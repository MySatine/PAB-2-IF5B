...
import com.if5b.tulisaja.databinding.ActivityRegisterBinding;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void register(String username, String password) {
        ...
        api.register(Utilities.TULIS_AJA_API_KEY, username, password).enqueue(new Callback<ValueNoData>() {
            @Override
